...
const Complete = ({data}) => {
  return (
    <div className='w-1/4 h-[300px] bg-linear-to-t from-[#000000] to-[#166D3B] rounded-lg p-5 overflow-auto shrink-0'>
                ...
                <div className='w-full flex items-center justify-center gap-3 mt-5 font-medium'>
                    <button className='py-2 px-10 bg-green-700 text-lg rounded-lg outline-none'>Completed</button>
                </div>
    </div>
  )
}
